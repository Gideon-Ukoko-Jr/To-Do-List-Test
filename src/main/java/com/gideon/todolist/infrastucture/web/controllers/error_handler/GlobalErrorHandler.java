package com.gideon.todolist.infrastucture.web.controllers.error_handler;

import com.gideon.todolist.infrastucture.web.models.ApiResponseJSON;
import com.gideon.todolist.usecase.exceptions.*;
...
@Slf4j
@ControllerAdvice(basePackages = "com.gideon.todolist.infrastructure.web.controllers")
public class GlobalErrorHandler {
    ...
    public ResponseEntity<ApiResponseJSON<String>> handleUnauthorisedAccessException(UnauthorisedException e) {
        log.info("error message: {}", e.getMessage());
        ApiResponseJSON<String> apiResponse = new ApiResponseJSON<>(e.getMessage());
